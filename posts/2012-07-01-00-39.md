...
### [Most of the current T420 wiki page is relevant](http://www.jakubkotowski.com/2011/06/thinkpad-t420-thinkfan-settings.html)
...
`MODULES` in rc.conf. To allow `thinkfan` to control the fan, enable 
`fan_control` by creating `/etc/modprobe.d/thinkfan.conf` with:
